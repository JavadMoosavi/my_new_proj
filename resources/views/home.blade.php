...
<body id="page-top" style="font-family: 'Sahel', sans-serif;">
        ...
        <div class="container px-4">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item"><a class="nav-link" href="#about">ثبت اثر</a></li>
                    <li class="nav-item"><a class="nav-link" href="tracking">رهگیری آثار ثبت شده</a></li>
    ...
    <header class="bg-primary bg-gradient text-white">
        <div class="container px-4 text-center">
            ...
            <a class="btn btn-lg btn-light" href="#about">ثبت اثر</a>
        </div>
    </header>
    <!-- About section-->
